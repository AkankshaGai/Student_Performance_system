    ...
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="form-outline mb-4"> <label class="form-label">Password</label><br>
         ...
         <div class="field">
          <a href="editTabe.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Login as admin</a>
        </div>  
        <div class="field">
          <a href="normal.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Login as normal</a>
        </div>  
...
<?php
if (isset($_POST['Login as normal'])) {
  echo "form submitted";
...
$query= mysqli_query($conn, "SELECT * FROM login_table WHERE email='$email' AND pass= '$pass'");
